      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            <img className="w-auto h-9" src="logo-2.png" alt="ReferMe Logo" />
            ...
            <p className="text-base leading-relaxed mt-7">
              ReferMe helps you connect and get referred to your dream
              opportunities. Join our community and grow your career!
            </p>
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
            ...
            <form action="#" method="POST" className="mt-6 flex flex-col gap-2">
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center px-6 py-3 font-semibold text-white bg-purple-600 rounded-md shadow hover:bg-purple-700 transition-all duration-200"
              >
                Subscribe
              </button>
            </form>
